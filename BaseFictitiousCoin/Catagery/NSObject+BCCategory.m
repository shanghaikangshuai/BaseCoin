 ...
 *  默认下载文件存储位置
 */
#define DefaultKeyedArchiverPath @"%@/Library/Caches/BCPath"

@implementation NSObject (BCCategory)
...
{
    NSString *path = [NSString stringWithFormat:[NSString stringWithFormat:@"%@/%@",DefaultKeyedArchiverPath,[NSString md532BitLower:keyString]],NSHomeDirectory()];
    return path;
}
